 ...
 */
export declare const MCA_FEE_ENQUIRY_STATES: readonly ["ANDHRA PRADESH", "ARUNACHAL PRADESH", "ASSAM", "BIHAR", "CHATTISGARH", "GOA", "GUJARAT", "HARYANA", "HIMACHAL PRADESH", "JHARKHAND", "KARNATAKA", "KERALA", "MADHYA PRADESH", "MAHARASHTRA", "MANIPUR", "MEGHALAYA", "MIZORAM", "NAGALAND", "ORISSA", "PUNJAB", "RAJASTHAN", "SIKKIM", "TAMIL NADU", "TELANGANA", "TRIPURA", "UTTAR PRADESH", "UTTARAKHAND", "WEST BENGAL", "ANDAMAN AND NICOBAR ISLANDS", "CHANDIGARH", "DADRA & NAGAR HAVELI", "DAMAN AND DIU", "DELHI", "JAMMU & KASHMIR", "LADAKH", "LAKSHADWEEP", "PONDICHERRY"];
